        ...
        >
          <div className="flex flex-col gap-6 p-2 rounded-xl border border-border bg-background-primary">
            ...
            <div className="w-1/2">
              <div className="flex justify-between pb-1">
                ...
                <div className="flex justify-center items-center">
                  ...
                  <div className="flex flex-col items-end pl-9 flex-nowrap">
                    <div className="text-text-subtitle text-sm">Tham chiếu</div>
            ...
            <div className="grid grid-cols-5 gap-1 w-full h-[calc(var(--app-height)-320px)]">
              <div className="col-span-3 bg-surface rounded-md h-full">
              ...
              <div className="col-span-2 grid grid-cols-2 max-xl:grid-cols-1 gap-1 overflow-hidden">
                ...
                <div className="col-span-1 bg-surface rounded-md">
                  ...
                  <div className="h-[calc(var(--app-height)-320px-36px-8px)] max-xl:h-[calc(var(--app-height)-320px-36px-8px-161px-161px-30px)]">
