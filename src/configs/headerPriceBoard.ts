...
export const ALL_COLUMNS = [
  ...
  { key: "ref", label: "TC", default: true, width: 42 },
  {
    ...
    default: true,
    children: [
      { key: "priceBuy3", label: "Giá 3", default: true, width: 68 },
      { key: "volumeBuy3", label: "KL 3", default: true, width: 68 },
      { key: "priceBuy2", label: "Giá 2", default: true, width: 68 },
      { key: "volumeBuy2", label: "KL 2", default: true, width: 68 },
      { key: "priceBuy1", label: "Giá 1", default: true, width: 68 },
      { key: "volumeBuy1", label: "KL 1", default: true, width: 68 },
    ],
  },
  {
    key: "match",
